    ...
    <div className="cm-login">
      ...
      <section className="cm-auth">
        ...
        <div className="cm-auth-inner">
          ...
          <h2>Inicia sesión</h2>
          <p className="cm-auth-lead">Acceso del personal · ingresa con tu código.</p>
            ...
            <div className="cm-field">
              ...
              <div className="cm-input-wrap">
                ...
                <input
                  id="password"
                  type="password"
                  placeholder="(en desarrollo: alfin123)"
          ...
          <p className="cm-auth-hint">
            Demo · Código <strong>OFI001</strong> · clave <strong>alfin123</strong>
          </p>
        </div>
      </section>
    </div>
